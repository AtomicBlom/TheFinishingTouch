...
public final class PlaneProjection
{
	 ...
	 */
	private static Vec3d intersectionLinePlane(Vec3d head, Vec3d look, Vec3d planeOrigin, Vec3d planeNormal)
	{
	...
	/*public static Vec3d calculateSlopeHit(BlockPos pos, EnumFacing blockFacing, EntityPlayer player)
	{
		...
		} else
		{
			...
			LogHelper.info("player clicked at {},{},{}", finalHitVector.x, finalHitVector.y, finalHitVector.z);
